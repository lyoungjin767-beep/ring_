...
const ahnJunggeunQuizQuestions = [
  ...
  {
    level: 4,
    question: "'한글'이라는 용어를 처음 만들고, 국어 문법을 체계적으로 정리하여 한글 연구에 일생을 바친 국어학자는 누구일까요?",
    choices: ["주시경", "최현배", "방정환", "지석영"],
    answer: 0,
    explanation: "정답은 주시경입니다. 국문연구소 등에서 한글 연구와 보급에 앞장선 국어학의 선구자입니다.",
  },
  {
    level: 4,
    question: "주시경 선생의 제자들이 중심으로 결성되어 한글날(가갸날)을 제정하고 『맞춤법 통일안』을 제정한 단체는 무엇일까요?",
    choices: ["조선어학회", "진단학회", "국문연구소", "한글사랑회"],
    answer: 0,
    explanation: "정답은 조선어학회입니다. 우리말과 글을 지키기 위해 노력한 대표적 학술 및 항일 단체입니다.",
  },
  {
    level: 4,
    question: "일제가 1942년 우리말 사전 편찬 작업을 하던 한글 학자들을 대거 체포하고 탄압한 사건은 무엇일까요?",
    choices: ["조선어학회 사건", "105인 사건", "국민보도연맹 사건", "신민회 사건"],
    answer: 0,
    explanation: "정답은 조선어학회 사건입니다. 민족 문화 말살 정책의 일환으로 한글 학자들을 억울하게 옥사시킨 사건입니다.",
  },
  {
    level: 4,
    question: "주시경 선생이 서재필 등과 함께 창간에 참여했던, 순한글로 발행된 한국 최초의 민간 신문은 무엇일까요?",
    choices: ["독립신문", "한성순보", "황성신문", "제국신문"],
    answer: 0,
    explanation: "정답은 독립신문입니다. 1896년 창간되어 국민 계몽과 자주독립 의식을 고취한 신문입니다.",
  },
  {
    level: 4,
    question: "조선어학회가 우리말을 지키기 위해 전국 각지의 사투리와 어휘를 모아 편찬하려 했던 책은 무엇일까요?",
    choices: ["우리말 큰사전", "국어문법", "동사강목", "조선상고사"],
    answer: 0,
    explanation: "정답은 우리말 큰사전입니다. 우리말 사전을 만들기 위해 원고를 집필하던 중 조선어학회 사건으로 중단되었습니다.",
  },
  {
    level: 5,
    question: "1919년 3·1 운동 당시 민족대표 33인 중 개신교계 대표로 참여하여 기미독립선언서에 서명한 인물은 누구일까요?",
    choices: ["이승훈", "김구", "안창호", "이회영"],
    answer: 0,
    explanation: "정답은 이승훈입니다. 남강 이승훈 선생이 개신교계를 대표하여 민족대표로 참여했습니다.",
  },
  {
    level: 5,
    question: "이승훈 선생이 평북 정주에 설립하여 윤동주, 백석, 소파 방정환 등 인재들을 배출한 명문 학교는 어디일까요?",
    choices: ["오산학교", "대성학교", "배재학당", "이화학당"],
    answer: 0,
    explanation: "정답은 오산학교입니다. 민족 의식을 심어주고 수많은 독립운동가와 문화재를 배출한 학교입니다.",
  },
  {
    level: 5,
    question: "3·1 운동 당시 민족대표 33인이 모여 기미독립선언서를 낭독하고 만세를 외친 서울의 장소는 어디일까요?",
    choices: ["태화관", "탑골공원", "덕수궁", "독립문"],
    answer: 0,
    explanation: "정답은 태화관입니다. 민족대표들은 태화관에 모여 선언서를 낭독한 후 일경에 자수했습니다.",
  },
  {
    level: 5,
    question: "탑골공원에 모여 있던 학생과 시민들이 독립선언서를 낭독하고 만세 시위를 시작한 장소는 어디일까요?",
    choices: ["탑골공원 (팔각정)", "태화관", "서대문형무소", "종로경찰서"],
    answer: 0,
    explanation: "정답은 탑골공원 (팔각정)입니다. 민족대표 대신 학생 대표가 선언서를 낭독하면서 3·1 운동이 전국으로 퍼졌습니다.",
  },
  {
    level: 5,
    question: "이승훈 선생이 교육 사업에 투신하기 전 도자기 상업 등으로 부를 축적했던 출신 배경은 무엇일까요?",
    choices: ["평안도 거상 (민족 자본가)", "조선 왕실 종친", "무관 출신 장군", "양반 유학자"],
    answer: 0,
    explanation: "정답은 평안도 거상 (민족 자본가)입니다. 자수성가한 사업가로서 번 돈을 교육과 독립운동 사업에 바쳤습니다.",
  },
];
